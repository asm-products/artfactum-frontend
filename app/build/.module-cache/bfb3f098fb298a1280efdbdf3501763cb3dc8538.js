'use strict';
 ...
 var Ajax = React.createClass({displayName: 'Ajax',
  ...
  React.createElement("ul", {className: "dropdownMenu", role: "menu", 'aria-labelledby': "dLabel"}, 
    React.createElement("li", null, React.createElement("a", {tabindex: "-1", href: "#"}, "Action"))
      )
), 
