'use strict';
 ...
 var Ajax = React.createClass({displayName: 'Ajax',
	...
	render: function(){
	  React.createElement("span", {className: this.state})
	}
  ...
  React.createElement("li", null, React.createElement("a", {href: "#"}, "Laughter"), " ", React.createElement("span", {className: "divider"}, "/")), 
  React.createElement("li", null, React.createElement("a", {href: "#"}, "Library"), " ", React.createElement("span", {className: "divider"}, "/")), 
